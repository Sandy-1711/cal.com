...
export function AppCard({ app, credentials, searchText, userAdminTeams }: AppCardProps) {
  ...
  const handleAppInstall = () => {
    ...
    // Apps with a custom setup form (per-user credential entry) need to be routed
    // through their /api/integrations/<type>/add GET handler so it can redirect to
    // /apps/<slug>/setup. Otherwise we'd fall through to the onboarding flow which
    // auto-installs with an empty credential.
